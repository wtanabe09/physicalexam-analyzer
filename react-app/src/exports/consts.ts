...
export const techniqueOptions: {value: string, label: string}[] = [
  { value: '00', label: 'テスト用' },
  { value: '01', label: '01-脈拍測定' }, // 手技1 （全身バイタル）
  { value: '02', label: '02-聴診・心臓・対人' }, // 手技2
  { value: '03', label: '03-ベッド・脚部・触診' }, // 手技3
  // ↓↓ 10/10のケース用
  { value: '04', label: '04-眼瞼結膜' }, //　（頭頸部）
  { value: '05', label: '05-甲状腺' },// （頭頸部）
  { value: '06', label: '06-頭頸部・リンパ節確認・触診' }, // （頭頸部）
  { value: '07', label: '07-肺正面・聴診・対ラング' }, //  (胸部)
  { value: '08', label: '08-聴診・背面・対ラング' }, //  (胸部)
  { value: '09', label: '09-静音浸透' }, // 
  // ↓↓ 11/7のケース用
  { value: '10', label: '手技1：テスト用' },
  { value: '11', label: '11-肺・正面・聴診' }, // 手技2 （胸部）
  { value: '12', label: '12-背中・静音浸透' }, //手技3 静音浸透が混ざった。打診と。
  { value: '13', label: '13-背中・打診' }, // 手技4
  { value: '14', label: '14-背中・聴診' }, // 手技5
  { value: '15', label: '15-背中・打診→聴診' }, // 手技6

  { value: '16', label: '16-脇・腕リンパ節' },
  { value: '17', label: '17-目・対光反射' },
  { value: '18', label: '18-目・服装反射' },
  { value: '19', label: '19-ベッド・腹部・聴診' }, // （腹部）
  { value: '20', label: '20-ベッド・腹部・打診' }, // （腹部）
  { value: '21', label: '21-ベッド・腹部・触診' }, // （腹部）
];
